                    ...
                    >
                        ...
                        <div className="space-y-4 relative">
                            <motion.h2
                                ...
                                style={{ fontFamily: 'Clash Display Semibold', lineHeight: '100%', letterSpacing: '-1px' }}
                            >
                                <span className="heading-underline block">BRANDING</span>
                                <div className="flex items-center gap-4 my-2">
                                    <div className="w-24 h-24 bg-[#FFDB71] rounded-full" style={{ animation: 'pulse 2s infinite' }}></div>
