...
const ServiceSection = () => {
  return (
    <section className="py-20 md:py-28 lg:py-32 bg-[#1A1B1E] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-2 lg:gap-2 items-center">
          ...
          >
            ...
            >
              7AVENUE® is a global branding and digital design agency building products, services, and eCommerce experiences that turn cultural values into company value.
            </motion.p>
          </motion.div>
